...
public class ExposableTextView extends TextView implements ExposableViewInterface, ExposableLayoutInterface {
    ...
    public ExposableTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ExposableTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
